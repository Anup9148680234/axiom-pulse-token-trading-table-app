  ...
  return (
    <header className="w-full border-b border-neutral-800 bg-[#050509] text-sm text-neutral-200 mb-2.5 px-4">
      <div className="mx-auto flex h-16 w-full items-between justify-between gap-6 px-2">
        ...
        {/* Center: Nav links */}
        <nav className="flex flex-1 items-center gap-3 -ml-3 -mt-px">
          {navItems.map((item) => (
            <button
              key={item}
        ...
        <div className="flex items-center gap-4">
          ...
          {/* Small stats pill */}
          <button className="flex items-center gap-2 rounded-full border border-neutral-800 bg-[#22242d] px-3 py-1.5 hover:bg-black/70">
